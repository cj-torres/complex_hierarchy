loss_df = read.csv("C:\\Users\\torre\\PycharmProjects\\complex_hierarchy\\data\\Output-2023-05-20\\lstm\\lstm_loss.csv")
...
ggplot(loss_df, aes(x = l0, y=g1.pref)) + geom_point()+geom_smooth(size=1, color="")+geom_rect(xmin=25, xmax=75, ymin=-1,ymax=1,alpha=.007,color="gray")+xlab("Number of Parameters (expected value)")+ylab("G1 Preference")+coord_cartesian(xlim=c(10,200), ylim=c(-.2, .6))+
